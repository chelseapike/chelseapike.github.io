var portfolio = [
...

  {
    ...
    githubLink: "https://chelseaclay.github.io/Project4_InteractivePhotoGallery/",
    liveLink: "https://github.com/chelseaclay/Project4_InteractivePhotoGallery",
...
////////////////////////////////////////////////////////
// Gallery Sliders and Lightbox
////////////////////////////////////////////////////////

var allGallery = '<div id="allGallery" class="slickSlidesAll" data-featherlight-gallery data-featherlight-filter="a"></div>';
var developGallery = '<div id="developGallery" class="slickSlidesDevelop" data-featherlight-gallery data-featherlight-filter="a"></div>';
var printGallery = '<div id="printGallery" class="slickSlidesPrint" data-featherlight-gallery data-featherlight-filter="a"></div>';
var campaignGallery = '<div id="campaignGallery" class="slickSlidesCampaign" data-featherlight-gallery data-featherlight-filter="a"></div>';
var miscGallery = '<div id="miscGallery" class="slickSlidesMisc" data-featherlight-gallery data-featherlight-filter="a"></div>';

var block1Content = '<div id="block1" class="blocks"></div>';
var block2Content = '<div id="block2" class="blocks"></div>';
var block3Content = '<div id="block3" class="blocks"></div>';
var block4Content = '<div id="block4" class="blocks"></div>';
var block5Content = '<div id="block5" class="blocks"></div>';
var block6Content = '<div id="block6" class="blocks"></div>';
var block7Content = '<div id="block7" class="blocks"></div>';
var block8Content = '<div id="block8" class="blocks"></div>';
var block9Content = '<div id="block9" class="blocks"></div>';
var block10Content = '<div id="block10" class="blocks"></div>';
var block11Content = '<div id="block11" class="blocks"></div>';
var block12Content = '<div id="block12" class="blocks"></div>';

function preload() {
  for(var i = 0; i < portfolio.length; i++) {
    var imgPre = new Image();
    imgPre.src = portfolio[i].lightbox;
  }
}

// Initialize the sliders
function sliderAll() {
  $(".slickSlidesAll").slick({
      dots: true,
      autoplay: true,
      autoplaySpeed: 5000,
      adaptiveHeight: true,
...
function sliderDevelop() {
  $(".slickSlidesDevelop").slick({
      dots: true,
      autoplay: true,
      autoplaySpeed: 5000,
      adaptiveHeight: true,
...
//Update the Gallery
function updateGallery(sortedArray, galleryLocation) {
  //Get the blocks
  for(var i = 0; i <= sortedArray.length; i++) {
    if(i <= 4) {
      $(galleryLocation).html(block1Content);
    } else if(i > 4 && i <= 8) {
      $(galleryLocation).html(block1Content + block2Content);
    } else if(i > 8 && i <= 12) {
      $(galleryLocation).html(block1Content + block2Content +block3Content);
    } else if(i > 12 && i <= 16) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content);
    } else if(i > 16 && i <= 20) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content);
    } else if(i > 20 && i <= 24) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content + block6Content);
    } else if(i > 24 && i <= 28) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content + block6Content + block7Content);
    } else if(i > 28 && i <= 32) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content + block6Content + block7Content + block8Content);
    } else if(i > 32 && i <= 36) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content + block6Content + block7Content + block8Content + block9Content);
    } else if(i > 36 && i <= 40) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content + block6Content + block7Content + block8Content + block9Content + block10Content);
    } else if(i > 40 && i <= 44) {
      $(galleryLocation).html(block1Content + block2Content +block3Content + block4Content + block5Content + block6Content + block7Content + block8Content + block9Content + block10Content + block11Content);
    } else if(i > 44 && i <= 48) {
  ...
  $.each(sortedArray, function(i, portfolio) {
    if(i <= 3) {
      ...
      $("#block1").append(galleryContent);
    } else if(i > 3 && i <= 7) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block2").append(galleryContent);
    } else if(i > 7 && i <= 11) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block3").append(galleryContent);
    } else if(i > 11 && i <= 15) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block4").append(galleryContent);
    } else if(i > 15 && i <= 19) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block5").append(galleryContent);
    } else if(i > 19 && i <= 23) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block6").append(galleryContent);
    } else if(i > 23 && i <= 27) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block7").append(galleryContent);
    } else if(i > 27 && i <= 31) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block8").append(galleryContent);
    } else if(i > 31 && i <= 35) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block9").append(galleryContent);
    } else if(i > 35 && i <= 39) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block10").append(galleryContent);
    } else if(i > 39 && i <= 43) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
      $("#block11").append(galleryContent);
    } else if(i > 43 && i <= 47) {
      galleryContent = '<a rel="portfolio" href="#lightboxContent" class="lightboxContent fancybox" index="' + i + '"><div class="galleryIMG"><img src="' + portfolio.thumb + '" alt="' + portfolio.title + '"></div></a>';
...
function lightboxContent(item, sortedArray) {
  var content =  '<ul class="projectSkills">';
      ...
      content +=    '<p class="projectTitle">' + sortedArray[item].title + '</p>';
      content +=    '<p class="projectDescrip">' + sortedArray[item].caption + '</p>';
      content +=  '</div>';
...
$("#all-work").click(function() {
  if($(this).hasClass("selected")) {
    $('#all-work').click(function(e) {
      e.stopPropagation();
    });
  } else {
    $("#portfolio-sort > li.selected").removeClass("selected");
    $(this).addClass("selected");
    $("#dotNav").empty();
    $("div").remove("#developGallery, #printGallery, #campaignGallery, #miscGallery");
    $("#gallery").append(allGallery);
    updateGallery(portfolio, "#allGallery");
    sliderAll();
    $(".fancybox").addClass("lightboxAll");
    $(".fancybox").attr("rel", "portfolio");
    $(".fancybox").click(function() {
      var itemClicked = $(this).attr("index");
      lightboxContent(itemClicked, portfolio);
    });
  }
});

$("#develop-work").click(function() {
  if($(this).hasClass("selected")) {
    $('#develop-work').click(function(e) {
      e.stopPropagation();
    });
  } else {
    $("#portfolio-sort > li.selected").removeClass("selected");
    $(this).addClass("selected");
    $("#dotNav").empty();
    $("div").remove("#allGallery, #printGallery, #campaignGallery, #miscGallery");
    $("#gallery").append(developGallery);
    updateGallery(developUpdate, "#developGallery");
    sliderDevelop();
    $(".fancybox").addClass("lightboxDevelop");
    $(".fancybox").attr("rel", "portfolioDevelop");
    $(".fancybox").click(function() {
      var itemClicked = $(this).attr("index");
      lightboxContent(itemClicked, developUpdate);
    });
  }
});
...
$("#print-work").click(function() {
  if($(this).hasClass("selected")) {
    ...
    $(this).addClass("selected");
    $("#dotNav").empty();
    $("div").remove("#allGallery, #developGallery, #campaignGallery, #miscGallery");
    $("#gallery").append(printGallery);
    updateGallery(printUpdate, "#printGallery");
    sliderPrint();
    $(".fancybox").addClass("lightboxPrint");
    $(".fancybox").attr("rel", "portfolioPrint");
    $(".fancybox").click(function() {
      var itemClicked = $(this).attr("index");
      lightboxContent(itemClicked, printUpdate);
    });
  }
});

$("#campaign-work").click(function() {
  if($(this).hasClass("selected")) {
    $('#campaign-work').click(function(e) {
      e.stopPropagation();
    });
  } else {
    $("#portfolio-sort > li.selected").removeClass("selected");
    $(this).addClass("selected");
    $("#dotNav").empty();
    $("div").remove("#allGallery, #printGallery, #developGallery, #miscGallery");
    $("#gallery").append(campaignGallery);
    updateGallery(campaignUpdate, "#campaignGallery");
    sliderCampaign();
    $(".fancybox").addClass("lightboxCampaign");
    $(".fancybox").attr("rel", "portfolioCampaign");
    $(".fancybox").click(function() {
      var itemClicked = $(this).attr("index");
...
$("#misc-work").click(function() {
  if($(this).hasClass("selected")) {
    $('#misc-work').click(function(e) {
      e.stopPropagation();
    });
  } else {
    $("#portfolio-sort > li.selected").removeClass("selected");
    $(this).addClass("selected");
    $("#dotNav").empty();
    $("div").remove("#allGallery, #printGallery, #developGallery, #campaignGallery");
    $("#gallery").append(miscGallery);
    updateGallery(miscUpdate, "#miscGallery");
    sliderMisc();
    $(".fancybox").addClass("lightboxMisc");
    $(".fancybox").attr("rel", "portfolioMisc");
    $(".fancybox").click(function() {
      var itemClicked = $(this).attr("index");
      lightboxContent(itemClicked, miscUpdate);
    });
  }
});
...
$(document).ready(function() {
  ...
  $(".lightboxContent").fancybox({
    ...
    beforeLoad: function() {
                              ...
                              } else if (gallery == "portfolioDevelop") {
                                itemClicked = itemClicked-4;
                                if(itemClicked <= -1 || itemClicked >= developUpdate.length) {
                                  $.fancybox.close();
                                } else {
                                  lightboxContent(itemClicked, developUpdate);
                                }
                              } else if (gallery == "portfolioPrint") {
                                itemClicked = itemClicked-4;
                                if(itemClicked <= -1 || itemClicked >= printUpdate.length) {
                                  $.fancybox.close();
                                } else {
                                  lightboxContent(itemClicked, printUpdate);
                                }
                              } else if (gallery == "portfolioCampaign") {
                                itemClicked = itemClicked-4;
                                if(itemClicked == -1 || itemClicked >= campaignUpdate.length) {
                                  $.fancybox.close();
                                } else {
                                  lightboxContent(itemClicked, campaignUpdate);
                                }
                              } else if (gallery == "miscCampaign") {
